...
struct HNSWGraph {
	...
	void HNSWGraph::SearchTemp(int thread_id,vector<set<pair<double,int>>>& local_candidates,vector<set<pair<double,int>>>& nearestNeighbors,unordered_set<int>& isVisited,omp_lock_t &lock_isVisited,int lc,int ef, Item& q) ;
