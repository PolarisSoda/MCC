...
struct HNSWGraph {
	...
	void SearchWorker(int thread_id,vector<set<pair<double,int>>>& local_candidates,vector<set<pair<double,int>>>& local_nearestNeighbors,unordered_set<int>& isVisited,std::atomic_flag &lock_isVisited,int lc,int ef, Item& q);
